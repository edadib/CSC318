...
if(mysqli_num_rows($sql) == 0){ header("Location: member_profile.php");
}else{
...
//add image
$pdf->Image('assets/img/members/profile.png',20,20,30);
...
// Line break
$pdf->Ln(20);
$pdf->Cell(40,10,'ADIB FARHAN',0,1);
$pdf->Cell(40,10,'Admin,',0,1);
