...
<?php
	...
	$sql = mysqli_query($connection, "SELECT * FROM staff WHERE icno='$icno'"); // query for selecting ic number from db
	...
	$delete = mysqli_query($connection, "DELETE FROM staff WHERE icno='$icno'"); // query for deleting data based on ic number
