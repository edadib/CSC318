...
if($password1 == $password2){ // if password 1 same as password 2 if(strlen($password1) >= 6){ // minimum 6 character
$pass = md5($password1); // md5 encrytion
$update = mysqli_query($connection, "UPDATE staff SET password='$pass' WHERE icno='$icno'"); // query update password
